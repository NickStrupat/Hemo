// Generated from c:\Dev\language testing\CSharp\CSharpLexer.g4 by ANTLR 4.7
...
public class CSharpLexer extends Lexer {
	...
	private Stack<Boolean> interpolatedVerbatums = new Stack<Boolean>();
	private Stack<Int32> curlyLevels = new Stack<Int32>();
	private Boolean verbatum;
	...
	public void action(RuleContext _localctx, int ruleIndex, int actionIndex) {
		...
		case 119:
			...
			break;
		case 120:
			INTERPOLATED_VERBATUM_STRING_START_action((RuleContext)_localctx, actionIndex);
			break;
		case 121:
	...
	private void INTERPOLATED_REGULAR_STRING_START_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 0:
			 interpolatedStringLevel++; interpolatedVerbatums.Push(false); verbatum = false; 
			break;
		}
	}
	private void INTERPOLATED_VERBATUM_STRING_START_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 1:
			 interpolatedStringLevel++; interpolatedVerbatums.Push(true); verbatum = true; 
			break;
		}
	}
	...
	private void DOUBLE_QUOTE_INSIDE_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 6:
			 interpolatedStringLevel--; interpolatedVerbatums.Pop();
			    verbatum = (interpolatedVerbatums.Count > 0 ? interpolatedVerbatums.Peek() : false); 
			break;
		}
	}
	...
	public boolean sempred(RuleContext _localctx, int ruleIndex, int predIndex) {
		...
		case 169:
			return VERBATUM_DOUBLE_QUOTE_INSIDE_sempred((RuleContext)_localctx, predIndex);
		case 171:
			return REGULAR_STRING_INSIDE_sempred((RuleContext)_localctx, predIndex);
		case 172:
			return VERBATUM_INSIDE_STRING_sempred((RuleContext)_localctx, predIndex);
		}
		return true;
	}
	...
	private boolean VERBATUM_DOUBLE_QUOTE_INSIDE_sempred(RuleContext _localctx, int predIndex) {
		switch (predIndex) {
		case 1:
			return   verbatum ;
		}
	...
	private boolean VERBATUM_INSIDE_STRING_sempred(RuleContext _localctx, int predIndex) {
		switch (predIndex) {
		case 3:
			return   verbatum ;
		}
